    ...
    <div className="p-6">
      ...
      {resources.length > 0 ? (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium uppercase ${getFileTypeColor(resource.fileType)}`}>
                    {resource.fileType}
                  </span>
        ...
        <div className="mt-12 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700 mb-2">No resources available</h2>
